...
{
    //std::cout << " DepthPacketStreamParser::onDataReceived " << std::endl;
  ...
  while(in_offset < in_length)
  {
    ...
    //std::cout << " DepthPacketStreamParser::onDataReceived 1" << std::endl;
    ...
    if(footer_found)
    {
      ...
      //std::cout << " DepthPacketStreamParser::onDataReceived 2" << std::endl;
